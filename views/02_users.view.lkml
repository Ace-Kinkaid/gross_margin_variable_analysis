view: users {
  ...
  dimension: email {
    label: "Email"
    #label: "{% if _user_attributes['can_see_sensitive_data'] == 'Yes' %} Email
...
#     timeframes: [time, date, week, month, raw]
  ...
  dimension: ssn_last_4 {
    #label: "SSN Last 4"
    label: "{% if _user_attributes['can_see_sensitive_data'] == 'Yes' %} SSN Last 4
    {% else %} SSN Last 4 (Redacted due to insufficient permissions)
    {% endif %}"
