- dashboard: business_pulse
  ...
  - title: Most Viewed Brands Online
    ...
    defaults_version: 1
    listen:
      #Brand: product_viewed.brand #removed as Brand is not a dashboard filter
      State: users.state
      City: users.city
      Traffic Source: users.traffic_source
      #Gender: users.gender #apparently renamed to "User Gender"
      User Gender: users.gender
      #Event Date: events.event_date #apparently renamed to "Date"
      Date: events.event_date
      Country: users.country
    row: 26
    col: 10
